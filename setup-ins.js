...
console.log('\x1b[36m%s\x1b[0m', '\n🚀 ShipFree SaaS Starter Setup (No-Docker Guide) 🚀\n');
...
const defaultUrl = 'postgres://postgres:postgres@localhost:5432/shipfree';
...
if (!currentDbUrl || currentDbUrl === defaultUrl) {
    ...
    console.log('      - Local Windows: postgres://postgres:password@localhost:5432/shipfree');
